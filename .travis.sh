...
export CC=gcc-10 && export CXX=g++-10
$CXX --version
$CXX -DNDEBUG -fopenmp -g0 -march=native -O3 -std=c++17 -ltbb -o ./binarytrees_benchmarksgame ./binarytrees_benchmarksgame.cpp ;
time ./binarytrees_benchmarksgame 21
rm -rf ./binarytrees_benchmarksgame
export CC=clang-10 && export CXX=clang++-10
$CXX --version
$CXX -DNDEBUG -fopenmp=libgomp -g0 -march=native -O3 -std=c++17 -ltbb -o ./binarytrees_benchmarksgame ./binarytrees_benchmarksgame.cpp ;
time ./binarytrees_benchmarksgame 21
rm -rf ./binarytrees_benchmarksgame
